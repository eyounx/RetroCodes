...
def _main_(args):
    ...
    frozen_graph = freeze_session(K.get_session(), output_names=['reshape_1/Reshape'])
    tf.train.write_graph(frozen_graph, "model/tiny_darknet/", "tiny_darknet_keras_v1.pb", as_text=False)
