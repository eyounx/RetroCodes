...
# from ..util.preprocessing import BatchGenerator
from keras.callbacks import EarlyStopping, ModelCheckpoint, TensorBoard
from ..util.utils import BoundBox
from .backend import TinyYoloFeature, FullYoloFeature, MobileNetFeature, SqueezeNetFeature, Inception3Feature, VGG16Feature, ResNet50Feature, TinyDarknetFeature
...
class YOLO(object):
    def __init__(self, architecture,
        ...
        elif architecture == 'Tiny Darknet':
            self.feature_extractor = TinyDarknetFeature(self.input_size)
        else:
        ...
        output = Conv2D(int (self.nb_box * (4 + 1 + self.nb_class) ),
                        (1,1), strides=(1,1),
                        padding='same',
                        name='conv_23',
                        kernel_initializer='lecun_normal')(features)

        output = Reshape((self.grid_h, self.grid_w, int(self.nb_box), 4 + 1 + self.nb_class))(output)
